...
const ViewBookDetails = () => {
  ...
  useEffect(() => {
    ...
    const fetch = async () => {
      const res = await axios.get(
        `https://bookstore-web-app-2.onrender.com/api/v1/get-book-by-id/${id}`
      );
  ...
  const addToFavourite = async () => {
    try {
      const response = await axios.put(
        "https://bookstore-web-app-2.onrender.com/api/v1/add-to-favourite",
        {},
        { headers }
      );
  ...
  const addToCart = async () => {
    try {
      const response = await axios.put(
        "https://bookstore-web-app-2.onrender.com/api/v1/add-to-cart",
        {},
        { headers }
      );
      alert(response.data.message);
  ...
  const deleteBook = async () => {
    try {
      const response = await axios.delete(
        "https://bookstore-web-app-2.onrender.com/api/v1/delete-book",
        { headers }
      );
      alert(response.data.message);
      history("/all-books");
